  ...
  return (
    <section className="w-full bg-gradient-to-br from-[#1a0003] via-[#5e020b] to-[#ad0e21] text-white py-32">
      <div className="max-w-[1230px] mx-auto flex flex-col lg:flex-row lg:justify-between">
        <div>
          <h2 className="text-3xl text-center md:text-start lg:text-5xl mb-10 leading-snug">
            Безопасность и прибыль <br /> — всё в одном месте
          </h2>
        </div>

        <div className="flex flex-col mt-6 lg:mt-0 text-center md:text-start ">
          <p>
            Ваши инвестиции в безопасности, а доход <br /> растёт вместе с
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white text-black p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-base text-gray-700">
              Все ваши данные и финансовые операции надёжно защищены с
              использованием современных методов шифрования и безопасности.
            </p>
          </div>
          ...
          <div className="bg-white text-black p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-base text-gray-700">
              Получайте стабильный доход до 10% в месяц, который напрямую
              зависит от роста мировой цены на золото.
            </p>
          </div>
          ...
          <div className="bg-white text-black p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-base text-gray-700">
              Открытая статистика и понятные условия без скрытых комиссий
              позволяют вам полностью контролировать свои инвестиции.
            </p>
          </div>
        </div>
      </div>
